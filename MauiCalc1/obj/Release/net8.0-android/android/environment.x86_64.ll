...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670899, ; uint32_t jnienv_initialize_method_token (0x6001db3)
	i32 100670898, ; uint32_t jnienv_registerjninatives_method_token (0x6001db2)
...
@dso_cache = dso_local local_unnamed_addr global [528 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3009679330374962978, ; hash 0x29c48767aed5cf22, from name: libaot-MauiCalc1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 80
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4835943322272474328, ; hash 0x431cb8d465f924d8, from name: libaot-MauiCalc1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 130
	...
	%struct.DSOCacheEntry {
		i64 5190046100632347635, ; hash 0x4806bf6e3417a3f3, from name: aot-MauiCalc1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 135
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.69_name, ; name: libaot-System.Net.Mail.dll.so
		ptr null; void* handle (0x0)
	}, ; 146
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8393038822794316199, ; hash 0x747a105752b7c9a7, from name: MauiCalc1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 228
	...
	%struct.DSOCacheEntry {
		i64 8628879648128732669, ; hash 0x77bff0527c4f8dfd, from name: aot-MauiCalc1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 241
	...
	%struct.DSOCacheEntry {
		i64 12083514587587273484, ; hash 0xa7b1447f0763e30c, from name: MauiCalc1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 347
...
@.env.3 = private unnamed_addr constant [37 x i8] c"aa106ea8-a3b6-44d1-9666-d8a5b608b6de\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.mauicalc1\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [24 x i8] c"libaot-MauiCalc1.dll.so\00", align 16
...
@.DSOCacheEntry.69_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 16

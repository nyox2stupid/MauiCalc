...
@dso_cache = dso_local local_unnamed_addr global [528 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 982398321, ; hash 0x3a8e3571, from name: MauiCalc1
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1310261648, ; hash 0x4e190190, from name: libaot-MauiCalc1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 145
	...
	%struct.DSOCacheEntry {
		i64 3062531948, ; hash 0xb68a876c, from name: libaot-MauiCalc1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 390
	...
	%struct.DSOCacheEntry {
		i64 3293349813, ; hash 0xc44c87b5, from name: MauiCalc1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 414
	...
	%struct.DSOCacheEntry {
		i64 4069245577, ; hash 0xf28bc289, from name: aot-MauiCalc1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 499
	...
	%struct.DSOCacheEntry {
		i64 4220047004, ; hash 0xfb88ce9c, from name: aot-MauiCalc1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiCalc1.dll.so
		ptr null; void* handle (0x0)
	}, ; 519
